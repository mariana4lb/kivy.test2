...
class MinhaApp(App):
    def build(self):
        ...
        btn2 = Button(text='Cliqe Aqui', haling='center')
        ...
        def acao_botao(instance):
            instance.text = 'Botâo Pressionado!'

        btn4 = Button(text='Botão 4')
        btn4.bind(on_press = acao_botao)
        layout.add_widget(btn4)

        info_label = Label(text='Pressione os botãoes para ver as diferentes propriedades em ação.')
